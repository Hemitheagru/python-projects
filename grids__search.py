...
#önce büyük adımlarla dene sonra daha küçük adımlar kullan
'''
GS parametreleri
estimator:sınıflandırma algoritması(neyi optimize etmek istediğimi
 pram_grid:prametreler/denenecekler
 scoring:neye göre skorlanacak:örn:accuracy
 cv:laç katmanlı olacağı
